...
import { Dot, EllipsisVertical, Search } from "lucide-react";
        ...
        <div className="mt-3 flex w-full flex-col items-center justify-center gap-3 p-2">
          ...
          <div className="flex h-[598px] w-full flex-col rounded-md bg-white p-1">
            <div className="flex h-12 w-full items-center justify-center">
              <div className="flex h-[30px] w-full items-center justify-between p-4">
                {/* Search  */}
                <div className="relative flex items-center justify-center p-1">
                  <input
                    ...
                    name=""
                    id=""
                    className="w-[300px] rounded-md border border-[#C2C2C2] py-1 pr-3 pl-7 outline-none placeholder:text-[14px]"
                    placeholder="Search"
                  />
