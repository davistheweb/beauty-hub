...
const CopyIcon = ({
  ...
  return (
    ...
    >
      ...
      />
      <path
        d="M4 12.6668C3.46957 12.6668 2.96086 12.4561 2.58579 12.081C2.21071 11.706 2 11.1973 2 10.6668V6.66683C2 4.15283 2 2.8955 2.78133 2.11483C3.56267 1.33416 4.81933 1.3335 7.33333 1.3335H10C10.5304 1.3335 11.0391 1.54421 11.4142 1.91928C11.7893 2.29436 12 2.80306 12 3.3335"
        stroke={color}
        strokeWidth="1.5"
      />
    </svg>
...
// Usage examples:
// <CopyIcon />
// <CopyIcon size={32} color="#3B82F6" />
// <CopyIcon size="32" color="#3B82F6" />
// <CopyIcon className="hover:opacity-80" />
